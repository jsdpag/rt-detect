...
function  v = evarchk( RewardMaxMs , RfXDeg , RfYDeg , RfRadDeg , ...
  RfAngleDeg , RfWinFactor , TargetTimeMs , RfTargetFactor , FixTolDeg ,...
...
% 
  ...
  lim.RfYDeg = [ -Inf , +Inf ] ;
  lim.RfRadDeg = [ 0 , +Inf ] ;
  lim.RfAngleDeg = [ -Inf , +Inf ] ;
  lim.RfWinFactor = [ 0 , +Inf ] ;
  lim.TargetTimeMs = [ 0 , +Inf ] ;
  ...
  v.RfYDeg = RfYDeg ;
  v.RfRadDeg = RfRadDeg ;
  v.RfAngleDeg = RfAngleDeg ;
  v.RfWinFactor = RfWinFactor ;
  v.TargetTimeMs = TargetTimeMs ;
